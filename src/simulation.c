...
command_t	*get_simtab(void)
{
	...
	command_t	data[SIM_ACTIONS_SIZE] = {
		{START_SIMULATION, my_strdup("START_SIMULATION"), NULL, 1},
		{STOP_SIMULATION, my_strdup("STOP_SIMULATION"), NULL, 1},
		{CYCLE_WAIT, my_strdup("CYCLE_WAIT"), my_fnew(), 3},
		{SIM_ACTIONS_SIZE, my_strdup("GET_INFO_SIMTIME"), NULL, 4}
	};
